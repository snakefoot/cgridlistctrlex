...
BEGIN_MESSAGE_MAP(CGridEditorComboBox, CComboBox)
	...
	ON_CONTROL_REFLECT_EX(CBN_SELCHANGE, OnChangeSelection)
	ON_CONTROL_REFLECT_EX(CBN_SELENDOK, OnChangeSelection)
	ON_CONTROL_REFLECT_EX(CBN_EDITCHANGE, OnChangeSelection)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
